...
INSERT INTO payments (id, rental_id, amount, session_id, session_url, status, type)
VALUES (50, 50, 22.22, 'sessionIdExcemple#', 'http://session-url.excemple', 'PENDING', 'PAYMENT');
